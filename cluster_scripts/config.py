...
# directory setup (NOTE: it's best to modify only 'startdir'
job_config['startdir'] = # (str) path to the remote foler for this project. Should be something like /dartfs/rc/lab/D/DBIC/CDL/<your_net_id>/<project_name>
...
job_config['queue'] =   # (str) options: default, test, largeq (when in doubt, use "largeq")
...
job_config['email_updates'] = # (str) what events you want to receive email notifications about (see options below)
job_config['email_addr'] = # (str) email address where you want job notifications sent
